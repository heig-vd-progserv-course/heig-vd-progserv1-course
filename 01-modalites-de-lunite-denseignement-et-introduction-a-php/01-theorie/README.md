...
d'enseignement et une introduction à PHP. Vous apprendrez les bases de PHP, y
...
De façon plus large, vous devriez être capable de :
...
La théorie, donnée oralement et disponible dans ces mêmes supports de cours,
couvre les concepts de base et avancés de PHP.

Un mini-projet est également prévu pour mettre en pratique les concepts appris
en classe.
