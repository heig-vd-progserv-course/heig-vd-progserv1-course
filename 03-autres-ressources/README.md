...
Ce dossier contient des ressources pour les personnes qui enseignent le cours
"_Programmation serveur 1 (ProgServ1)"_ ou d'autres contenus qui ne sont pas
directement liés au contenu du cours, mais qui peuvent être utiles pour la
préparation et la gestion du cours.

## Table des matières

- [Table des matières](#table-des-matières)
- [Avant le début du cours](#avant-le-début-du-cours)
...
Il est important pour nous d'avoir votre avis, car cela nous aide à améliorer le
cours et à mieux répondre à vos besoins.

Toutes les données sont anonymes et elles ne sont utilisées que pour améliorer
le cours. Nous prendrons du temps lors du prochain cours pour un moment de
discussions/partages sur ces résultats.
...
- Pour chacune de ces affirmations, sélectionnez l'option qui reflète le mieux
  ...
  - Options :
    ...
    - Le cours est variée, motivante et permet de ne pas m'ennuyer
