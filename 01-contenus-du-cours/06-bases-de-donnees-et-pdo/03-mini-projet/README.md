...
([Formulaires HTML et validation](../../04-formulaires-html-et-validation/03-mini-projet/README.md)),
...
> [Activation des messages d'erreurs de PHP dans le navigateur](../../01-modalites-de-lunite-denseignement-et-introduction-a-php/03-mini-projet/README.md#activation-des-messages-derreurs-de-php-dans-le-navigateur).
