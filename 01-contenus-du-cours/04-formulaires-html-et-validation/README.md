...
>
> - Autres formats :
>   [Présentation (web)](https://heig-vd-progserv-course.github.io/heig-vd-progserv1-course/01-contenus-du-cours/04-formulaires-html-et-validation/presentation.html)
>   ·
>   [Présentation (PDF)](https://heig-vd-progserv-course.github.io/heig-vd-progserv1-course/01-contenus-du-cours/04-formulaires-html-et-validation/04-formulaires-html-et-validation-presentation.pdf).
...
- La méthode `POST` envoie les données du formulaire dans le corps de la requête
  ...
  requête ressemblera à ceci : `http://localhost:8080/login.php`, et les données
