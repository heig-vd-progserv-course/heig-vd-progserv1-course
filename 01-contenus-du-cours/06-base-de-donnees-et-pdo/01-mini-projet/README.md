# Base de données et PDO - Mini-projet

Ce mini-projet est conçu pour vous permettre de mettre en pratique les concepts
théoriques vus dans le cours _["Base de données et PDO"](../README.md)_.
...
_[Introduction à PHP](../../01-modalites-de-lunite-denseignement-et-introduction-a-php/01-mini-projet/README.md)_
...
([Formulaires HTML et validation](../../04-formulaires-html-et-validation/01-mini-projet/README.md)),
...
> [Activation des messages d'erreurs de PHP dans le navigateur](../../01-modalites-de-lunite-denseignement-et-introduction-a-php/01-mini-projet/README.md#activation-des-messages-derreurs-de-php-dans-le-navigateur).
